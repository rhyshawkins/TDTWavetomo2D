...
You can create your own gridi.vtx file through any other method
including the tools within FMST. The only restriction for
use with the Wavetomo2D software is that the width and height
of the grid must be powers of 2, that is the number of vertices
