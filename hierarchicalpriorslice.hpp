...
#pragma once
#ifndef hierarchicalpriorslice_hpp
#define hierarchicalpriorslice_hpp
...
class HierarchicalPriorSlice {
public:

  HierarchicalPriorSlice(GlobalSlice &global, double sigma);
  ~HierarchicalPriorSlice();
...
#endif // hierarchicalpriorslice_hpp
